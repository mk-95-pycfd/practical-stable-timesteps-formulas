...
# load data
stability_data = np.loadtxt('./RK3-ssp-stability.txt',delimiter=",",usecols=[0,1])
#convert data
...
ax.loglog(Reh, Courant, color=colors[1], linewidth=1.5, marker=markers[0], markersize=4.5, label="RK3 Taylor Vortex")
# plot the analytical stability boundaries
lower_bound = lambda Pe: Pe/2.0/1.59
upper_bound = lambda Pe: 3.0/2/np.sqrt(3)*np.ones_like(Pe)
